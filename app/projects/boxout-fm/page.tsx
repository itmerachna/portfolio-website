...
import projectData from '../../assets/projects/boxout-fm/data.json';

const project = { ...projectData, slug: 'boxout-fm' } as ProjectData;

export default function BoxoutFmPage() {
  return (
    <>
      <Navbar solid />
