...
import projectData from '../../assets/projects/dawnshard/data.json';

const project = { ...projectData, slug: 'dawnshard' } as ProjectData;

export default function DawnshardPage() {
  return (
    <>
      <Navbar solid />
