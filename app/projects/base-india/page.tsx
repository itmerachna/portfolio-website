...
import projectData from '../../assets/projects/base-india/data.json';

const project = { ...projectData, slug: 'base-india' } as ProjectData;

export default function BaseIndiaPage() {
  return (
    <>
      <Navbar solid />
