...
import projectData from '../../assets/projects/xeon-protocol/data.json';

const project = { ...projectData, slug: 'xeon-protocol' } as ProjectData;

export default function XeonProtocolPage() {
  return (
    <>
      <Navbar solid />
