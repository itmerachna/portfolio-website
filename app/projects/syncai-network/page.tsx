...
import projectData from '../../assets/projects/syncai-network/data.json';

const project = { ...projectData, slug: 'syncai-network' } as ProjectData;

export default function SyncaiNetworkPage() {
  return (
    <>
      <Navbar solid />
