...
import projectData from '../../assets/projects/personal-art/data.json';

const project = { ...projectData, slug: 'personal-art' } as ProjectData;

export default function PersonalArtPage() {
  return (
    <>
      <Navbar solid />
