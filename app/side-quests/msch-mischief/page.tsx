...
import projectData from '../../assets/side-quests/msch-mischief/data.json';

const project = { ...projectData, slug: 'msch-mischief' } as ProjectData;

export default function MschMischiefPage() {
  return (
    <>
      <Navbar solid />
        ...
        <div className="relative">
          ...
          <div className="px-4 md:px-8 lg:px-12 pb-24">
            <div className="max-w-4xl mx-auto">
              <ProjectContent content={project.content} projectSlug={project.slug} basePath="side-quests" />
            </div>
          </div>
        </div>
      </div>
